...
3. `READ gitnexus://repo/novabrands-mgmt/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/novabrands-mgmt/context` | Codebase overview, check index freshness |
| `gitnexus://repo/novabrands-mgmt/clusters` | All functional areas |
| `gitnexus://repo/novabrands-mgmt/processes` | All execution flows |
| `gitnexus://repo/novabrands-mgmt/process/{name}` | Step-by-step execution trace |
